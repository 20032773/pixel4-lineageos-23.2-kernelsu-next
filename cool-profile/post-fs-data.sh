...
cap_max_if_higher /sys/devices/system/cpu/cpufreq/policy4/scaling_max_freq 1708800 CPU4
cap_max_if_higher /sys/devices/system/cpu/cpufreq/policy7/scaling_max_freq 1920000 CPU7

# Adreno 640: one step below the stock 585 MHz peak.
cap_max_if_higher /sys/class/kgsl/kgsl-3d0/devfreq/max_freq 427000000 GPU
